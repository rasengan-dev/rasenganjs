...
function requireUtils() {
  ...
  utils.createLineSplittingTransform = utils.Deferred = utils.TYPE_PREVIOUS_RESOLVED = utils.TYPE_URL = utils.TYPE_SYMBOL = utils.TYPE_SET = utils.TYPE_REGEXP = utils.TYPE_PROMISE = utils.TYPE_NULL_OBJECT = utils.TYPE_MAP = utils.TYPE_ERROR = utils.TYPE_DATE = utils.TYPE_BIGINT = utils.UNDEFINED = utils.POSITIVE_INFINITY = utils.NULL = utils.NEGATIVE_ZERO = utils.NEGATIVE_INFINITY = utils.NAN = utils.HOLE = void 0;
  utils.HOLE = -1;
  utils.NAN = -2;
  utils.NEGATIVE_INFINITY = -3;
  utils.NEGATIVE_ZERO = -4;
  utils.NULL = -5;
  utils.POSITIVE_INFINITY = -6;
  utils.UNDEFINED = -7;
  utils.TYPE_BIGINT = "B";
  utils.TYPE_DATE = "D";
  utils.TYPE_ERROR = "E";
  utils.TYPE_MAP = "M";
  utils.TYPE_NULL_OBJECT = "N";
  utils.TYPE_PROMISE = "P";
  utils.TYPE_REGEXP = "R";
  utils.TYPE_SET = "S";
  utils.TYPE_SYMBOL = "Y";
  utils.TYPE_URL = "U";
  utils.TYPE_PREVIOUS_RESOLVED = "Z";
  class Deferred {
    constructor() {
  ...
  utils.createLineSplittingTransform = createLineSplittingTransform;
  return utils;
}
...
function requireFlatten() {
  ...
  function stringify(input, index) {
    ...
    while (stack.length > 0) {
      ...
      const partsForObj = (obj) => Object.keys(obj).map((k) => `"_${flatten$1.call(this, k)}":${flatten$1.call(this, obj[k])}`).join(",");
      let error = null;
          ...
          if (!isArray && plugins) {
            for (const plugin of plugins) {
              ...
              if (Array.isArray(pluginResult)) {
                ...
                if (rest.length > 0) {
                  str[index2] += `,${rest.map((v) => flatten$1.call(this, v)).join(",")}`;
                }
                str[index2] += "]";
                break;
              }
          ...
          if (!pluginHandled) {
            ...
            if (isArray) {
              for (let i = 0; i < input2.length; i++)
                result += (i ? "," : "") + (i in input2 ? flatten$1.call(this, input2[i]) : utils_js_1.HOLE);
              str[index2] = `${result}]`;
              ...
              if (input2.size > 0) {
                str[index2] = `["${utils_js_1.TYPE_SET}",${[...input2].map((val) => flatten$1.call(this, val)).join(",")}]`;
              } else {
...
var unflatten = {};
var hasRequiredUnflatten;
function requireUnflatten() {
  if (hasRequiredUnflatten) return unflatten;
  hasRequiredUnflatten = 1;
  Object.defineProperty(unflatten, "__esModule", { value: true });
  unflatten.unflatten = void 0;
  const utils_js_1 = /* @__PURE__ */ requireUtils();
  const globalObj = typeof window !== "undefined" ? window : typeof globalThis !== "undefined" ? globalThis : void 0;
  function unflatten$1(parsed) {
  ...
  unflatten.unflatten = unflatten$1;
...
var hasRequiredTurboStream;
function requireTurboStream() {
  if (hasRequiredTurboStream) return turboStream;
  hasRequiredTurboStream = 1;
  Object.defineProperty(turboStream, "__esModule", { value: true });
  turboStream.encode = turboStream.decode = void 0;
  const flatten_js_1 = /* @__PURE__ */ requireFlatten();
  const unflatten_js_1 = /* @__PURE__ */ requireUnflatten();
  const utils_js_1 = /* @__PURE__ */ requireUtils();
...
function requireDevelopment() {
  ...
  var __toESM2 = (mod, isNodeMode, target) => (target = mod != null ? __create2(__getProtoOf2(mod)) : {}, __copyProps2(
    ...
    !mod || !mod.__esModule ? __defProp3(target, "default", { value: mod, enumerable: true }) : target,
    mod
  ));
...
`,
  ...
  var React3 = __toESM2(React);
  var React$1 = __toESM2(React);
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  var import_turbo_stream = /* @__PURE__ */ requireTurboStream();
  ...
  var React8 = __toESM2(React);
  var React7 = __toESM2(React);
  var React5 = __toESM2(React);
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  var import_turbo_stream2 = /* @__PURE__ */ requireTurboStream();
...
var developmentExports = /* @__PURE__ */ requireDevelopment();
