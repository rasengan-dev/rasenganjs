import { require_react } from './chunk-LPOV34HP.js';
import { __toESM } from './chunk-G3PMV62Z.js';

// ../../node_modules/.pnpm/prism-react-renderer@2.4.1_react@19.1.0/node_modules/prism-react-renderer/dist/index.mjs
...
(Prism.languages.markup = {
          ...
          if ((a = l.languages[e3])) {
            ...
            if (
              ...
              for (var s = 0, i = r2.length; s < i; s++)
                r2[s] instanceof RegExp && (r2[s] = { pattern: r2[s] }),
                  n(r2[s]);
            else n(r2);
          }
        });
      ...
      l =
        ...
        ['url', 'bold', 'italic', 'strike'].forEach(function (n2) {
          ['url', 'bold', 'italic', 'strike', 'code-snippet'].forEach(
            function (e2) {
              n2 !== e2 &&
                (o.languages.markdown[n2].inside.content.inside[e2] =
                  o.languages.markdown[e2]);
            }
          );
        }),
  ...
  Prism.hooks.add('after-tokenize', function (e) {
        ...
        if ('keyword' === n.type && 'mutation' === n.content) {
          ...
          if (
            ...
            for (; o < a; o++) {
              var r2 = c(0);
              'variable' === r2.type &&
                (g(r2, 'variable-input'), t.push(r2.content));
            }
            o = a + 1;
          }
          if (
    ...
    function g(e2, n2) {
      var t2 = e2.alias;
      t2 ? Array.isArray(t2) || (e2.alias = t2 = [t2]) : (e2.alias = t2 = []),
        t2.push(n2);
    }
  }),
  (Prism.languages.sql = {
  ...
  (function (b) {
    ...
    function l(a2, e2, r2) {
      var n2 = b.tokenize(a2, {
          interpolation: { pattern: RegExp(s), lookbehind: true },
        }),
        p = 0,
        d = {},
        n2 = h(
          n2
            .map(function (e3) {
              ...
              for (
                ...
                a2.indexOf(
                  ((t2 = p++),
                  (n3 = '___' + r2.toUpperCase() + '_' + t2 + '___'))
                );
        ...
        (function e3(n3) {
          for (var t2 = 0; t2 < n3.length; t2++) {
            ...
            'string' == typeof c || 'string' == typeof c.content
              ? ((a3 = g[p]),
                -1 !==
                  (u2 = (l2 = 'string' == typeof c ? c : c.content).indexOf(
                    a3
                  )) &&
                  (++p,
                  ...
                  3 === (i = b.tokenize(o, i)).length &&
                    ((s2 = [1, 1]).push.apply(
                      s2,
                      h(i[1], b.languages.javascript, 'javascript')
                    ),
                    i.splice.apply(i, s2)),
                  ...
                  'string' == typeof c
                    ? (n3.splice.apply(n3, [t2, 1].concat(o)),
                      (t2 += o.length - 1))
                    : (c.content = o)))
        ...
        r2 =
          (s =
            'RegExp' === e.util.type(s)
              ? (e.languages.javascript[r2] = { pattern: s })
              : s).inside || {};
        ...
        'string' != typeof a2 &&
          ('tag' === a2.type && a2.content[0] && 'tag' === a2.content[0].type
            ? '</' === a2.content[0].content[0].content
              ? 0 < n2.length &&
                n2[n2.length - 1].tagName === o(a2.content[0].content[1]) &&
                n2.pop()
          ...
          (r22 || 'string' == typeof a2) &&
            ...
            ((r22 = o(a2)),
            t2 < e2.length - 1 &&
              ('string' == typeof e2[t2 + 1] ||
                'plain-text' === e2[t2 + 1].type) &&
  ...
  (0, import_react2.useCallback)(
    (_a) => {
      ...
      if (typeof style === 'object')
        output.style = __spreadValues(
          __spreadValues({}, output.style || {}),
          style
        );
      return output;
    },
