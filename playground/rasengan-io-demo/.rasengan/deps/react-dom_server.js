import { require_react_dom } from './chunk-BTNRKHLG.js';
  ...
  '../../node_modules/.pnpm/react-dom@19.1.1_react@19.1.1/node_modules/react-dom/cjs/react-dom-server-legacy.browser.development.js'(
    ...
    (function () {
      ...
      function abortTaskSoft(task) {
        ...
        task = task.blockedSegment;
        null !== task &&
          ((task.status = 3), finishedTask(this, boundary, task));
      }
        ...
        if (null === boundary) {
          ...
          (boundary.pendingTasks--,
            boundary.status !== CLIENT_RENDERED &&
              ...
              (task = logRecoverableError(request, error, segment, null)),
              (boundary.status = CLIENT_RENDERED),
              encodeErrorForBoundary(boundary, task, error, segment, true),
      ...
      function flushCompletedQueues(request, destination) {
        try {
          if (!(0 < request.pendingRootTasks)) {
            ...
            renderState$jscomp$0.preconnects.forEach(
              flushResource,
              destination
            );
            renderState$jscomp$0.preconnects.clear();
            renderState$jscomp$0.fontPreloads.forEach(
              flushResource,
              destination
            );
            ...
            renderState$jscomp$0.bulkPreloads.forEach(
              flushResource,
              destination
            );
      ...
      var React = require_react(),
        ...
        REACT_PROVIDER_TYPE = /* @__PURE__ */ Symbol.for('react.provider'),
              ...
              var bucket =
                'use-credentials' === crossOrigin
                  ...
                  : 'string' === typeof crossOrigin
                    ...
                    : 'default';
              if (
                !resumableState.connectResources[bucket].hasOwnProperty(href)
              ) {
  ...
  '../../node_modules/.pnpm/react-dom@19.1.1_react@19.1.1/node_modules/react-dom/cjs/react-dom-server.browser.development.js'(
    ...
    (function () {
      ...
      var NoContribution = 0,
        ...
        boundaryPreambleContributionChunkStart =
          stringToPrecomputedChunk('<!--'),
        boundaryPreambleContributionChunkEnd = stringToPrecomputedChunk('-->'),
