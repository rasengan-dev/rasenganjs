  ...
  return (
    <section className="w-full bg-background font-inter overflow-auto h-screen">
      ...
      <main className="w-full flex mt-8">
        <div className="w-[280px] border-r-[1px] border-r-border text-foreground">
          <aside className="sticky top-8 w-full h-full max-h-[calc(100vh-(var(--spacing)*14.25))] overflow-y-auto pt-[60px] p-4">
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-col w-full text-sm py-4">
                <div className="px-4 py-1 border-l-[1px] border-l-[#333] text-foreground/80 cursor-pointer hover:text-primary hover:border-l-primary/60 transition-all">
