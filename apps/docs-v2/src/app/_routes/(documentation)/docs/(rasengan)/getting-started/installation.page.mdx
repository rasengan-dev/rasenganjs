...
<StepItem
  ...
  className="mt-8"
>
  ```bash title="Terminal" npx create-rasengan@latest ```
</StepItem>
...
<StepItem
  ...
  `}
>
  ```bash title="Terminal" - What would you like to name your project? - Which
  language would you like to use for your project? - Which template would you
  like to use? ```
</StepItem>
...
<StepItem
  ...
  `}
>
  ```bash title="Terminal" mkdir public src touch rasengan.config.js ```
</StepItem>
...
<StepItem
  ...
  `}
>
  ```bash title="Terminal" touch tsconfig.json rasengan-env.d.ts ```
</StepItem>
