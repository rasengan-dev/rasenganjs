...
By default, when using the [`create-rasengan CLI`](/packages/create-rasengan) to create a new project, the `@rasenganjs/image` package is already installed.
...
<Note title="objectfit is lowercase" type="warning">
