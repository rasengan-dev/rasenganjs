  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        id: randomId(),
        name: 'Context',
        link: '/docs/futon/api-reference/context',
        level: 2,
      },
      {
        id: randomId(),
        name: 'Request',
        link: '/docs/futon/api-reference/request',
        level: 2,
      },
      {
        id: randomId(),
        name: 'Response',
        link: '/docs/futon/api-reference/response',
        level: 2,
      },
      {
        id: randomId(),
      ...
      },
      {
        id: randomId(),
        name: 'Adapters',
        link: '/docs/futon/api-reference/adapters',
        level: 2,
      },
      {
        id: randomId(),
        name: 'Hooks',
        link: '/docs/futon/api-reference/hooks',
        level: 2,
      },
      {
        id: randomId(),
        name: 'Errors',
        link: '/docs/futon/api-reference/errors',
        level: 2,
      },
    ],
  },
