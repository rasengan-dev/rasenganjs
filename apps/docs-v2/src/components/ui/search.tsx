...
export const SearchButton: React.FC<SearchButtonProps> = ({
  ...
  const baseClassName =
    'md:min-w-[120px] justify-between transition-transform duration-400 translate-y-0 h-auto cursor-pointer hover:bg-transparent border shadow-none';
        ...
        return (
          ...
          >
            ...
            <div>
              ...
              {(() => {
                const secondaryVal = getByPath<string | number>(
                  hit,
              ...
              {(() => {
                const tertiaryVal = getByPath<string | number>(
                  hit,
