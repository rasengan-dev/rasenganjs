...
import {
  ...
  AlertWithLink,
} from '@/components/common/atoms/alerts';
import { Note } from '@/components/common/molecules/note';
import KageDemoTrial from '@/components/features/tour';
import BlogDetailsHeader from '@/components/common/molecules/blog-header-details';
...
export default defineMDXConfig({
      ...
      return (
        <pre
          className={`
            ...
            [&_span>mark[data-highlighted-chars]]:py-[0.1rem]
          `}
          {...props}
        >
          {children}
  ...
  toc: (toc) => {
    ...
    return (
      <div className="sticky w-[300px] top-24 max-h-[calc(100vh-1rem)] overflow-y-auto hidden xl:flex flex-col gap-8 hide-scrollbar pb-20">
        <div className="mt-12">
