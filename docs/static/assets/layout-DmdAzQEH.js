import { j as s, V as a } from './vendor-CfbgIbdB.js';
import { N as t, F as e } from './shared-components-CkrC6jAk.js';
const n = () =>
  s.jsxs('section', {
    ...
    children: [
      s.jsx(t, {}),
      s.jsx('main', {
        className: 'pt-20 w-full min-h-screen max-w-[1200px] mx-auto docs',
        children: s.jsx(a, {}),
      }),
      s.jsx(e, {}),
    ],
