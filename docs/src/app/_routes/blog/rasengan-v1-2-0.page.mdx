...
We are excited to announce the release of Rasengan.js v1.2.0 🎉
...
You don’t switch frameworks or mental models.
...
Learn more about [Pre-rendering](/docs/rendering/prerendering) 
...
[Upgrade now](/docs/getting-started/upgrading#upgrade-from-1.1.x-to-1.2.x) and have fun Ninja!
