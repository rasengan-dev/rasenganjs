...
import { FileCog, PencilRuler, RotateCw } from 'lucide-react';
    ...
    <section className="w-full overflow-hidden">
      <section className="w-full relative px-4 xl:px-20 lg:h-screen lg:max-h-[800px] lg:min-h-[800px] flex flex-col lg:flex-row justify-start lg:justify-between items-center gap-8 pt-[60px] overflow-hidden">
        <div className="w-full lg:w-1/2 mt-20 lg:mt-0 z-20">
          ...
          <h1 className="text-[45px] leading-[50px] md:text-5xl md:leading-[55px] lg:text-[62px] text-foreground font-medium lg:leading-[70px] text-center lg:text-start">
      ...
      <section className="relative px-4 xl:px-20 py-20 pt-20 border-y-[1px] border-border/60">
        ...
        <div className="relative mt-20 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 z-10">
          <FeatureCard
            title="Routing"
            description="Define routes using either config-based or file-based routing, giving you full control over your app structure."
            icon={
              <svg
                width="18"
                height="18"
          ...
          <FeatureCard
            title="SSG"
            description="Build static sites with the SSG (Static Site Generation) feature and unlock the power of simplicity."
            icon={<FileCog className="text-primary" />}
          />
          <FeatureCard
            title="Lazy Loading"
            description="Lazy load routes to improve performance and reduce initial bundle size."
          ...
          <Link to="/blog/rasengan-v1-2-1">
            <FeatureCard
              ...
              className="bg-[#0B1A2F] dark border border-transparent hover:border-primary/30"
            />
          </Link>
        </div>
        <div
