...
A **Router** in Rasengan.js is a collection of pages grouped under a common structure. It defines how different pages are connected and whether they share a common **Layout**.
