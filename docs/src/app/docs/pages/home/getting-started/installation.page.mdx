...
The best way to start a new **Rasengan.js** project is with **[create-rasengan CLI](/docs/api-reference/create-rasengan)**, which sets everything up for you automatically. 
